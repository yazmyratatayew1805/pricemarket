...
use App\Domain\Cart\Projectors\CartDurationProjector;
use App\Domain\Cart\Projectors\CartItemProjector;
use App\Domain\Cart\Projectors\CartProjector;
use App\Domain\Cart\Reactors\CartPaymentPaidReactor;
use App\Domain\Inventory\Projectors\InventoryProjector;
use App\Domain\Inventory\Reactors\InventoryForAddedCartItemReactor;
use App\Domain\Inventory\Reactors\InventoryForRemovedCartItemReactor;
use App\Domain\Order\Projectors\OrderProjector;
use App\Domain\Order\Reactors\CartToOrderReactor;
use App\Domain\Order\Reactors\OrderPaymentPaidReactor;
use App\Domain\Order\Reactors\PaymentForOrderFailedReactor;
use App\Domain\Payment\Projectors\PaymentProjector;
use App\Domain\Payment\Reactors\OrderToPaymentReactor;
...
return [
    ...
    'projectors' => [
        ...
        PaymentProjector::class,
        InventoryProjector::class,
        CartDurationProjector::class,
    ],
     ...
     */
    'reactors' => [
        CartToOrderReactor::class,
        OrderToPaymentReactor::class,
        PaymentForOrderFailedReactor::class,
        CartPaymentPaidReactor::class,
        OrderPaymentPaidReactor::class,
        InventoryForAddedCartItemReactor::class,
        InventoryForRemovedCartItemReactor::class,
    ],
     ...
     */
    'event_serializer' => JsonSerializer::class,
